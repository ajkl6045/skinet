...
import { IPaginaion, Pagination } from '../shared/models/pagination';
...
shopParams = new ShopParams();
  ...
  params = params.append('search', this.shopParams.search);
    ...
    return this.http.get<IPaginaion>(this.baseUrl + 'products', {observe: 'response', params})
    .pipe(
      map(response => {
        this.products = [...this.products, ...response.body.data]; // response.body.data;
